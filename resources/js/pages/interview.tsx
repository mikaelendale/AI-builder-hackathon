...
const PERSONA_SCRIPTS = {
    selam: {
        ...
        lang: 'en',
        type: 'selam' as const,
        description: 'Clean benchmark: 40 hrs/wk, 6500 ETB, pension deducted, all clauses MET.',
    ...
    abel: {
        ...
        lang: 'am',
        type: 'abel' as const,
        description: 'Ambiguous duration ("after the rains") -> Triggers honest UNCLEAR & targeted follow-up probe.',
    ...
    minor: {
        name: 'Yordanos Girma',
        age: 14,
        role: 'Workshop Assistant (Minor Hard Stop)',
        lang: 'en',
        type: 'synthetic' as const,
        description: 'Under-15 hard case: triggers instant hard stop, audit flag, and interview termination.',
